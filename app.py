...
if busqueda:
    ...
    if any(p in busqueda for p in ["alargador", "zapatilla", "alargadores"]):
        ...
        st.info("ℹ️ ANÁLISIS DE TECNOLOGÍA. Para su aprobación con fondos SEP, este artículo requiere obligatoriamente una Especificación Técnica detallada y una Justificación Pedagógica explícita asociada a la acción PME.")
